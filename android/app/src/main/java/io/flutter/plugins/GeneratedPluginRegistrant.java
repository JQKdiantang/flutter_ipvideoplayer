...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new br.com.felnanuke2.media_cast_dlna.MediaCastDlnaPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin media_cast_dlna, br.com.felnanuke2.media_cast_dlna.MediaCastDlnaPlugin", e);
    }
    try {
